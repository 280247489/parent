...
public class RSAUtil {
    ...
    public static void main(String[] arg0) throws Exception {
        String myLife = "myLife";
        byte[] publicKey = encryptByPublicKey(myLife.getBytes(),RSA_PUBLIC_KEY.getBytes());
        System.out.println(publicKey);
        String pubStr = decryptByPublicKey(publicKey,RSA_PUBLIC_KEY.getBytes()).toString();
        System.out.println(pubStr);
        String priStr = decryptByPrivateKey(publicKey,RSA_PRIVATE_KEY.getBytes()).toString();
